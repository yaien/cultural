...
func (r *FileRepository) Update(ctx context.Context, file *models.File) error {
	res, err := r.db.Collection("files").ReplaceOne(ctx, bson.M{"_id": file.ID}, file)
	if err != nil {
...
func (r *FileRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*models.File, error) {
	...
	err := r.db.Collection("files").FindOne(ctx, bson.M{"_id": id}).Decode(&file)
	if err != nil {
...
func (r *FileRepository) GetByOrganizationIDAndName(ctx context.Context, organizationID primitive.ObjectID, name string) (*models.File, error) {
	var file models.File
...
func (r *FileRepository) RenameByOrganizationIDAndName(ctx context.Context, organizationID primitive.ObjectID, oldName string, newName string) error {
...
func (r *FileRepository) GetByOrganizationID(ctx context.Context, organizationID primitive.ObjectID) ([]*models.File, error) {
