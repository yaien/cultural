...
// GetDimensionByContentType determines the dimensions of a file based on its content type. It supports both images and videos.
func GetDimensionByContentType(ctx context.Context, src, contentType string) (width, height, variant int, err error) {
	switch {
