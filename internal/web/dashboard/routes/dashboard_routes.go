...
func dashboard(mono *infrastructure.Monolith, app *application.Application, md *middlewares.Middlewares) {
	...
	{
		ctrl := controllers.NewActionsController(app.Label.Drafts)
...

	{
		...
		mono.DashboardRouter.HandleFunc("PUT /dashboard/products/{id}", ctrl.Update)
		mono.DashboardRouter.HandleFunc("DELETE /dashboard/products/{id}", ctrl.Delete)
		mono.DashboardRouter.HandleFunc("GET /dashboard/products/{id}/delete", ctrl.DeleteModal)
